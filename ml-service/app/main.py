...
# Detect CUDA status at module load
...
# Secara otomatis menggunakan GPU (cuda) jika tersedia
MODEL_DEVICE = os.getenv("YOLO_DEVICE", "cuda" if CUDA_AVAILABLE else "cpu")
...
async def lifespan(app: FastAPI):
    ...
    # Pindahkan model ke GPU saat aplikasi start jika CUDA tersedia
    if "cuda" in MODEL_DEVICE.lower() and CUDA_AVAILABLE:
